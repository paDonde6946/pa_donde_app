...
RutasResponse rutasResponseFromJson(String str) =>
    RutasResponse.fromJson(json.decode(str));

String rutasResponseToJson(RutasResponse data) => json.encode(data.toJson());
